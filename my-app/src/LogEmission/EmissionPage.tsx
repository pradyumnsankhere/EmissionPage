...
interface EmissionPageprops extends WithStyles<typeof styles> {}
class EmissionPage extends Component<EmissionPageprops> {
  render() {
...
export default withStyles(styles)(EmissionPage);
